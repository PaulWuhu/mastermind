...
const Score = () => {
  ...
  {!scores?.length && (
    <div className="text-gray-700">
      <p className="text-2xl font-semibold">There is no active player now</p>
      <p className="text-2xl font-semibold">Create a new account to play the game!</p>
    </div>
  )}
  ...
  <Link to={"/"} className="text-blue-500 text-2xl font-bold hover:underline">
    Back to home page
  </Link>
</div>
  )
